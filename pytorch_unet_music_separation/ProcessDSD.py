...
PATH_DSD_SOURCE = ["/media/data/rainiejjli/music_dataset/DSD100/Sources/Dev",
                   "/media/data/rainiejjli/music_dataset/DSD100/Sources/Test"]
PATH_DSD_MIXTURE = ["/media/data/rainiejjli/music_dataset/DSD100/Mixtures/Dev",
                    "/media/data/rainiejjli/music_dataset/DSD100/Mixtures/Test"]
...
for mix_dir, source_dir in zip(list_mix_dir,  list_source_dir):
    ...
    utils.SaveSpectrogram(y_mix, y_vocal, y_inst, fname)


rand_voc = np.random.randint(100, size=40)
rand_bass = np.random.randint(100, size=40)
rand_drums = np.random.randint(100, size=40)
rand_other = np.random.randint(100, size=40)
